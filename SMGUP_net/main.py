...
# BASE_DIR = os.path.abspath('/home/thirt/SMGUP_net/code')
...
# args = argparse.Namespace(config=f"{BASE_DIR}/experiments/config.yaml", evaluate=False)

parser = argparse.ArgumentParser(description='implementation of SMGUP-net')
parser.add_argument('-e', '--evaluate', dest='evaluate', action='store_true', help='evaluate model on validation set')
parser.add_argument('--config', type=str, default = 'experiments/config.yaml', help='path to the config path, relative to main.py')
...
def main():  
    # load cfg
    config_path = f'{BASE_DIR}/{args.config}'
